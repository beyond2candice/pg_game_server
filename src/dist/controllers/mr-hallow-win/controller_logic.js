...
const mrhallowwinlinhaperda = __importDefault(require("../../jsons/mr-hallow-win/linhaperda")); //输

const mrhallowwinlinhaganho = __importDefault(require("../../jsons/mr-hallow-win/linhaganho")); //赢


const mrhallowwinlinhabonus = __importDefault(require("../../jsons/mr-hallow-win/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield mrhallowwinfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield mrhallowwinfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = mrhallowwinjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, mrhallowwinjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, mrhallowwinjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return mrhallowwinlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return mrhallowwinlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return mrhallowwinlinhabonus.default.GetJson(json);
    },
