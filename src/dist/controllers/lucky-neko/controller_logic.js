...
const luckynekolinhaperda = __importDefault(require("../../jsons/lucky-neko/linhaperda")); //输


const luckynekolinhabonus = __importDefault(require("../../jsons/lucky-neko/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield luckynekofunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield luckynekofunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = luckynekojsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, luckynekojsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, luckynekojsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return luckynekolinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return luckynekolinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                lcc: cartajsonValue.lcc, 
                lcm: cartajsonValue.lcm, 
                lcrp: cartajsonValue.lcrp, 
                lctp: cartajsonValue.lctp, 
