...
const safariwildslinhaganho = __importDefault(require("../../jsons/safari-wilds/linhaganho")); //赢
...
exports.default = {
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = safariwildsjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, safariwildsjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, safariwildsjsonresult.default.GetGameJsons());
        });
    },
    ...
    taskWinJsonData(json) {
        return safariwildslinhaganho.default.GetJson(json);
    },
