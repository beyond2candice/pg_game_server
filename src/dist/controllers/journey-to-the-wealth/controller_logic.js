...
const journeytothewealthlinhaperda = __importDefault(require("../../jsons/journey-to-the-wealth/linhaperda")); //输

const journeytothewealthlinhaganho = __importDefault(require("../../jsons/journey-to-the-wealth/linhaganho")); //赢


const journeytothewealthlinhabonus = __importDefault(require("../../jsons/journey-to-the-wealth/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield journeytothewealthfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield journeytothewealthfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = journeytothewealthjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, journeytothewealthjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, journeytothewealthjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return journeytothewealthlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return journeytothewealthlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return journeytothewealthlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                si: { 
                cfp: cartajsonValue.cfp, 
                cfs: cartajsonValue.cfs, 
