...
const muaythaichampiolinhaperda = __importDefault(require("../../jsons/muay-thai-champio/linhaperda")); //输

const muaythaichampiolinhaganho = __importDefault(require("../../jsons/muay-thai-champio/linhaganho")); //赢


const muaythaichampiolinhabonus = __importDefault(require("../../jsons/muay-thai-champio/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield muaythaichampiofunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield muaythaichampiofunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = muaythaichampiojsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, muaythaichampiojsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, muaythaichampiojsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return muaythaichampiolinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return muaythaichampiolinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return muaythaichampiolinhabonus.default.GetJson(json);
    },
