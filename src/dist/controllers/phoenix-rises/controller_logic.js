...
const phoenixriseslinhaperda = __importDefault(require("../../jsons/phoenix-rises/linhaperda")); //输

const phoenixriseslinhaganho = __importDefault(require("../../jsons/phoenix-rises/linhaganho")); //赢


const phoenixriseslinhabonus = __importDefault(require("../../jsons/phoenix-rises/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield phoenixrisesfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield phoenixrisesfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = phoenixrisesjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, phoenixrisesjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, phoenixrisesjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return phoenixriseslinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return phoenixriseslinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return phoenixriseslinhabonus.default.GetJson(json);
    },
