...
const ninjaraccoonlinhaperda = __importDefault(require("../../jsons/ninja-raccoon/linhaperda")); //输

const ninjaraccoonlinhaganho = __importDefault(require("../../jsons/ninja-raccoon/linhaganho")); //赢


const ninjaraccoonlinhabonus = __importDefault(require("../../jsons/ninja-raccoon/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield ninjaraccoonfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield ninjaraccoonfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = ninjaraccoonjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, ninjaraccoonjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, ninjaraccoonjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return ninjaraccoonlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return ninjaraccoonlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return ninjaraccoonlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                mlw: cartajsonValue.mlw, 
                mr: cartajsonValue.mr, 
                mrl: cartajsonValue.mrl, 
                mrns: cartajsonValue.mrns, 
                mrtw: cartajsonValue.mrtw, 
                msnww: cartajsonValue.msnww, 
                mwip: cartajsonValue.mwip, 
                mwp: cartajsonValue.mwp, 
                mwpl: cartajsonValue.mwpl, 
                nst: cartajsonValue.nst, 
                ocr: cartajsonValue.ocr, 
                omrl: cartajsonValue.omrl, 
