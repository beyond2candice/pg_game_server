...
const ganeshagoldlinhaperda = __importDefault(require("../../jsons/ganesha-gold/linhaperda")); //输

const ganeshagoldlinhaganho = __importDefault(require("../../jsons/ganesha-gold/linhaganho")); //赢


const ganeshagoldlinhabonus = __importDefault(require("../../jsons/ganesha-gold/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield ganeshagoldfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield ganeshagoldfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = ganeshagoldjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, ganeshagoldjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, ganeshagoldjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return ganeshagoldlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return ganeshagoldlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return ganeshagoldlinhabonus.default.GetJson(json);
    },
