...
const gdnicefirelinhaperda = __importDefault(require("../../jsons/gdn-ice-fire/linhaperda")); //输

const gdnicefirelinhaganho = __importDefault(require("../../jsons/gdn-ice-fire/linhaganho")); //赢


const gdnicefirelinhabonus = __importDefault(require("../../jsons/gdn-ice-fire/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield gdnicefirefunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield gdnicefirefunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = gdnicefirejsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, gdnicefirejsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, gdnicefirejsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return gdnicefirelinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return gdnicefirelinhaganho.default.GetJson(json);
    },
    GetWinJson(ganhojson, step, ml, cs, bet, prevBalance) {
        ...
        if (ganhojson.fs) {
            ...
            if (fs.hasOwnProperty('slw')) {
                fs.slw = allfunctions_1.default.MultiplyValueWithFix(fs.slw, betRate);
            }
            if (fs.hasOwnProperty('stw')) {
                fs.stw = allfunctions_1.default.MultiplyValueWithFix(fs.stw, betRate);
            }
            if (fs.hasOwnProperty('stwm')) {
                fs.stwm = allfunctions_1.default.MultiplyValueWithFix(fs.stwm, betRate);
            }
        }
        let json = {
            dt: {
    ...
    taskBonusJsonData(json) {
        return gdnicefirelinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                lwm: cartajsonValue.lwm, 
                mr: cartajsonValue.mr, 
                norl: cartajsonValue.norl, 
