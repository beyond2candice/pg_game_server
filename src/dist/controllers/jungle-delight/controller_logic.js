...
const jungledelightlinhaperda = __importDefault(require("../../jsons/jungle-delight/linhaperda")); //输

const jungledelightlinhaganho = __importDefault(require("../../jsons/jungle-delight/linhaganho")); //赢


const jungledelightlinhabonus = __importDefault(require("../../jsons/jungle-delight/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield jungledelightfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield jungledelightfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = jungledelightjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, jungledelightjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, jungledelightjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return jungledelightlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return jungledelightlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return jungledelightlinhabonus.default.GetJson(json);
    },
