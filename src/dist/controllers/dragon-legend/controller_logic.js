...
const dragonlegendlinhaperda = __importDefault(require("../../jsons/dragon-legend/linhaperda")); //输

const dragonlegendlinhaganho = __importDefault(require("../../jsons/dragon-legend/linhaganho")); //赢


const dragonlegendlinhabonus = __importDefault(require("../../jsons/dragon-legend/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield dragonlegendfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield dragonlegendfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = dragonlegendjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
    ...
    taskLostJsonData(json) {
        return dragonlegendlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return dragonlegendlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return dragonlegendlinhabonus.default.GetJson(json);
    },
