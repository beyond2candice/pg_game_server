...
const legendofhouyilinhaperda = __importDefault(require("../../jsons/legend-of-hou-yi/linhaperda")); //输

const legendofhouyilinhaganho = __importDefault(require("../../jsons/legend-of-hou-yi/linhaganho")); //赢


const legendofhouyilinhabonus = __importDefault(require("../../jsons/legend-of-hou-yi/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield legendofhouyifunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield legendofhouyifunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = legendofhouyijsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, legendofhouyijsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, legendofhouyijsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return legendofhouyilinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return legendofhouyilinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return legendofhouyilinhabonus.default.GetJson(json);
    },
