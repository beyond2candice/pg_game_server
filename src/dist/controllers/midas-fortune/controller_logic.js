...
const midasfortunelinhaperda = __importDefault(require("../../jsons/midas-fortune/linhaperda")); //输


const midasfortunelinhabonus = __importDefault(require("../../jsons/midas-fortune/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield midasfortunefunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield midasfortunefunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = midasfortunejsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, midasfortunejsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, midasfortunejsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return midasfortunelinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return midasfortunelinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                si: { 
                am: cartajsonValue.am, 
                cgm: cartajsonValue.cgm, 
                cgsp: cartajsonValue.cgsp, 
                ...
                gpps: cartajsonValue.gpps, 
                gsp: cartajsonValue.gsp, 
                gwt: cartajsonValue.gwt, 
                hashr: cartajsonValue.hashr, 
                mr: cartajsonValue.mr, 
                ngsp: cartajsonValue.ngsp, 
