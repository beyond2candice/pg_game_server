...
const winwinfishprawncrablinhaperda = __importDefault(require("../../jsons/win-win-fish-prawn-crab/linhaperda")); //输


const winwinfishprawncrablinhabonus = __importDefault(require("../../jsons/win-win-fish-prawn-crab/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield winwinfishprawncrabfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield winwinfishprawncrabfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = winwinfishprawncrabjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, bet, ret, gamename, winwinfishprawncrabjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, winwinfishprawncrabjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return winwinfishprawncrablinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return winwinfishprawncrablinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                si: { 
                btw: allfunctions_1.default.MultiplyValueWithFix(cartajsonValue.btw, betRate), 
