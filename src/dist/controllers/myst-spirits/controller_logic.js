...
const mystspiritslinhaperda = __importDefault(require("../../jsons/myst-spirits/linhaperda")); //输


const mystspiritslinhabonus = __importDefault(require("../../jsons/myst-spirits/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield mystspiritsfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield mystspiritsfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = mystspiritsjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, mystspiritsjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, mystspiritsjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return mystspiritslinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return mystspiritslinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                em: cartajsonValue.em, 
                emb: cartajsonValue.emb, 
                eo: cartajsonValue.eo, 
                eob: cartajsonValue.eob, 
