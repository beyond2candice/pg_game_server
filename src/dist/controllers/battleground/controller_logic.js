...
const battlegroundlinhaperda = __importDefault(require("../../jsons/battleground/linhaperda")); //输


const battlegroundlinhabonus = __importDefault(require("../../jsons/battleground/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield battlegroundfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield battlegroundfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = battlegroundjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, battlegroundjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, battlegroundjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return battlegroundlinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return battlegroundlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                smc: cartajsonValue.smc, 
                smcp: cartajsonValue.smcp, 
