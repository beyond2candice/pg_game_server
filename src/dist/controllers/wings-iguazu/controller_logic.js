...
const wingsiguazulinhaperda = __importDefault(require("../../jsons/wings-iguazu/linhaperda")); //输

const wingsiguazulinhaganho = __importDefault(require("../../jsons/wings-iguazu/linhaganho")); //赢


const wingsiguazulinhabonus = __importDefault(require("../../jsons/wings-iguazu/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield wingsiguazufunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield wingsiguazufunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = wingsiguazujsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, wingsiguazujsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, wingsiguazujsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return wingsiguazulinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return wingsiguazulinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return wingsiguazulinhabonus.default.GetJson(json);
    },
