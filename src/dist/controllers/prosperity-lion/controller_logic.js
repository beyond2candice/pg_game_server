...
const prosperitylionlinhaperda = __importDefault(require("../../jsons/prosperity-lion/linhaperda")); //输

const prosperitylionlinhaganho = __importDefault(require("../../jsons/prosperity-lion/linhaganho")); //赢


const prosperitylionlinhabonus = __importDefault(require("../../jsons/prosperity-lion/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield prosperitylionfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield prosperitylionfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = prosperitylionjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, prosperitylionjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, prosperitylionjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return prosperitylionlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return prosperitylionlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return prosperitylionlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                ldf: cartajsonValue.ldf, 
                lf: cartajsonValue.lf, 
