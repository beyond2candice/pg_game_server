...
const lgdmonkeykglinhaperda = __importDefault(require("../../jsons/lgd-monkey-kg/linhaperda")); //输


const lgdmonkeykglinhabonus = __importDefault(require("../../jsons/lgd-monkey-kg/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield lgdmonkeykgfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield lgdmonkeykgfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = lgdmonkeykgjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, lgdmonkeykgjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, lgdmonkeykgjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return lgdmonkeykglinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return lgdmonkeykglinhabonus.default.GetJson(json);
    },
