...
const luckycloverlinhaperda = __importDefault(require("../../jsons/lucky-clover/linhaperda")); //输

const luckycloverlinhaganho = __importDefault(require("../../jsons/lucky-clover/linhaganho")); //赢


const luckycloverlinhabonus = __importDefault(require("../../jsons/lucky-clover/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield luckycloverfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield luckycloverfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = luckycloverjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, luckycloverjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, luckycloverjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return luckycloverlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return luckycloverlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return luckycloverlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                ifa: cartajsonValue.ifa, 
                imw: cartajsonValue.imw, 
                inwsf: cartajsonValue.inwsf, 
                mf: cartajsonValue.mf, 
                mr: cartajsonValue.mr, 
                nst: cartajsonValue.nst, 
                nus: cartajsonValue.nus, 
                nwpl: cartajsonValue.nwpl, 
