...
const cruiseroyalelinhaperda = __importDefault(require("../../jsons/cruise-royale/linhaperda")); //输


const cruiseroyalelinhabonus = __importDefault(require("../../jsons/cruise-royale/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield cruiseroyalefunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield cruiseroyalefunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = cruiseroyalejsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, cruiseroyalejsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, cruiseroyalejsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return cruiseroyalelinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return cruiseroyalelinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        if (cartajsonValue.cwc === 1) {
            valorganho = allfunctions_1.default.MultiplyValueWithFix(cartajsonValue.actw, betRate);
        }
