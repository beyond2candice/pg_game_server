...
const hotpotlinhaperda = __importDefault(require("../../jsons/hotpot/linhaperda")); //输

const hotpotlinhaganho = __importDefault(require("../../jsons/hotpot/linhaganho")); //赢


const hotpotlinhabonus = __importDefault(require("../../jsons/hotpot/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield hotpotfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield hotpotfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = hotpotjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, hotpotjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, hotpotjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return hotpotlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return hotpotlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return hotpotlinhabonus.default.GetJson(json);
    },
