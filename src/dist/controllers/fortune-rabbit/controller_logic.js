...
const fortunerabbitlinhaperda = __importDefault(require("../../jsons/fortune-rabbit/linhaperda")); //输

const fortunerabbitlinhaganho = __importDefault(require("../../jsons/fortune-rabbit/linhaganho")); //赢


const fortunerabbitlinhabonus = __importDefault(require("../../jsons/fortune-rabbit/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield fortunerabbitfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield fortunerabbitfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = fortunerabbitjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, fortunerabbitjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, fortunerabbitjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return fortunerabbitlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return fortunerabbitlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return fortunerabbitlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                si: { 
                cpf: allfunctions_1.default.MultiplyCpfValue(cartajsonValue.cpf, betRate), 
                ...
                iff: cartajsonValue.iff, 
                ift: cartajsonValue.ift, 
