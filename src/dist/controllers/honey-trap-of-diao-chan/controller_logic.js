...
const honeytrapofdiaochanlinhaperda = __importDefault(require("../../jsons/honey-trap-of-diao-chan/linhaperda")); //输

const honeytrapofdiaochanlinhaganho = __importDefault(require("../../jsons/honey-trap-of-diao-chan/linhaganho")); //赢


const honeytrapofdiaochanlinhabonus = __importDefault(require("../../jsons/honey-trap-of-diao-chan/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield honeytrapofdiaochanfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield honeytrapofdiaochanfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = honeytrapofdiaochanjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, honeytrapofdiaochanjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, honeytrapofdiaochanjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return honeytrapofdiaochanlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return honeytrapofdiaochanlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return honeytrapofdiaochanlinhabonus.default.GetJson(json);
    },
