...
const cryptfortunelinhaperda = __importDefault(require("../../jsons/crypt-fortune/linhaperda")); //输

const cryptfortunelinhaganho = __importDefault(require("../../jsons/crypt-fortune/linhaganho")); //赢


const cryptfortunelinhabonus = __importDefault(require("../../jsons/crypt-fortune/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield cryptfortunefunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield cryptfortunefunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = cryptfortunejsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, cryptfortunejsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, cryptfortunejsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return cryptfortunelinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return cryptfortunelinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return cryptfortunelinhabonus.default.GetJson(json);
    },
