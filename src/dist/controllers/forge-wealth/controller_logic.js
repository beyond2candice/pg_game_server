...
const forgewealthlinhaperda = __importDefault(require("../../jsons/forge-wealth/linhaperda")); //输


const forgewealthlinhabonus = __importDefault(require("../../jsons/forge-wealth/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield forgewealthfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield forgewealthfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = forgewealthjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, forgewealthjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, forgewealthjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return forgewealthlinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return forgewealthlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                si: { 
                acmp: cartajsonValue.acmp, 
                cmp: cartajsonValue.cmp, 
