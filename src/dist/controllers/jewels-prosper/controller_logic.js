...
const jewelsprosperlinhaperda = __importDefault(require("../../jsons/jewels-prosper/linhaperda")); //输

const jewelsprosperlinhaganho = __importDefault(require("../../jsons/jewels-prosper/linhaganho")); //赢


const jewelsprosperlinhabonus = __importDefault(require("../../jsons/jewels-prosper/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield jewelsprosperfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield jewelsprosperfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = jewelsprosperjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, jewelsprosperjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, jewelsprosperjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return jewelsprosperlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return jewelsprosperlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return jewelsprosperlinhabonus.default.GetJson(json);
    },
