...
const reelloveylinhaperda = __importDefault(require("../../jsons/reel-lovey/linhaperda")); //输

const reelloveylinhaganho = __importDefault(require("../../jsons/reel-lovey/linhaganho")); //赢


const reelloveylinhabonus = __importDefault(require("../../jsons/reel-lovey/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield reelloveyfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield reelloveyfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = reelloveyjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, reelloveyjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, reelloveyjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return reelloveylinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return reelloveylinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return reelloveylinhabonus.default.GetJson(json);
    },
