...
const ninjavssamurailinhaperda = __importDefault(require("../../jsons/ninja-vs-samurai/linhaperda")); //输

const ninjavssamurailinhaganho = __importDefault(require("../../jsons/ninja-vs-samurai/linhaganho")); //赢


const ninjavssamurailinhabonus = __importDefault(require("../../jsons/ninja-vs-samurai/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield ninjavssamuraifunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield ninjavssamuraifunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = ninjavssamuraijsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, ninjavssamuraijsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, ninjavssamuraijsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return ninjavssamurailinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return ninjavssamurailinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return ninjavssamurailinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                evt: cartajsonValue.evt, 
                evts: cartajsonValue.evts, 
                ...
                nevts: cartajsonValue.nevts, 
                nm: cartajsonValue.nm, 
