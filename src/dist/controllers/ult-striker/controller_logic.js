...
const ultstrikerlinhaperda = __importDefault(require("../../jsons/ult-striker/linhaperda")); //输


const ultstrikerlinhabonus = __importDefault(require("../../jsons/ult-striker/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield ultstrikerfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield ultstrikerfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = ultstrikerjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, ultstrikerjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, ultstrikerjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return ultstrikerlinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return ultstrikerlinhabonus.default.GetJson(json);
    },
