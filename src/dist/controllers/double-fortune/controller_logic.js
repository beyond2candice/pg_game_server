...
const doublefortunelinhaperda = __importDefault(require("../../jsons/double-fortune/linhaperda")); //输

const doublefortunelinhaganho = __importDefault(require("../../jsons/double-fortune/linhaganho")); //赢


const doublefortunelinhabonus = __importDefault(require("../../jsons/double-fortune/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield doublefortunefunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield doublefortunefunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = doublefortunejsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, doublefortunejsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, doublefortunejsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return doublefortunelinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return doublefortunelinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return doublefortunelinhabonus.default.GetJson(json);
    },
