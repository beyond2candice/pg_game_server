...
const fortuneoxlinhaperda = __importDefault(require("../../jsons/fortune-ox/linhaperda")); //输

const fortuneoxlinhaganho = __importDefault(require("../../jsons/fortune-ox/linhaganho")); //赢


const fortuneoxlinhabonus = __importDefault(require("../../jsons/fortune-ox/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield fortuneoxfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield fortuneoxfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = fortuneoxjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, fortuneoxjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, fortuneoxjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return fortuneoxlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return fortuneoxlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return fortuneoxlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                rf: cartajsonValue.rf, 
                rl: cartajsonValue.rl, 
                rtf: cartajsonValue.rtf, 
