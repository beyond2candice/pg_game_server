...
const fortunetigerlinhaperda = __importDefault(require("../../jsons/fortune-tiger/linhaperda")); //输

const fortunetigerlinhaganho = __importDefault(require("../../jsons/fortune-tiger/linhaganho")); //赢


const fortunetigerlinhabonus = __importDefault(require("../../jsons/fortune-tiger/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield fortunetigerfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield fortunetigerfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = fortunetigerjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, fortunetigerjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, fortunetigerjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return fortunetigerlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return fortunetigerlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return fortunetigerlinhabonus.default.GetJson(json);
    },
