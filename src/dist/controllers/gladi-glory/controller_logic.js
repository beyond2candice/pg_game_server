...
const gladiglorylinhaperda = __importDefault(require("../../jsons/gladi-glory/linhaperda")); //输


const gladiglorylinhabonus = __importDefault(require("../../jsons/gladi-glory/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield gladigloryfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield gladigloryfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = gladigloryjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
    ...
    taskLostJsonData(json) {
        return gladiglorylinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return gladiglorylinhabonus.default.GetJson(json);
    },
