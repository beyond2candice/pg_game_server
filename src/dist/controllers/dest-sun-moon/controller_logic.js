...
const destsunmoonlinhaperda = __importDefault(require("../../jsons/dest-sun-moon/linhaperda")); //输


const destsunmoonlinhabonus = __importDefault(require("../../jsons/dest-sun-moon/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield destsunmoonfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield destsunmoonfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = destsunmoonjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, destsunmoonjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, destsunmoonjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return destsunmoonlinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return destsunmoonlinhabonus.default.GetJson(json);
    },
