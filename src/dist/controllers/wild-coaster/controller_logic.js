...
const wildcoasterlinhaperda = __importDefault(require("../../jsons/wild-coaster/linhaperda")); //输


const wildcoasterlinhabonus = __importDefault(require("../../jsons/wild-coaster/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield wildcoasterfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield wildcoasterfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = wildcoasterjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, wildcoasterjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, wildcoasterjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return wildcoasterlinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return wildcoasterlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                si: { 
                btorl: cartajsonValue.btorl, 
                btrl: cartajsonValue.btrl, 
                btwl: cartajsonValue.btwl, 
                btwp: cartajsonValue.btwp, 
                ...
                ttorl: cartajsonValue.ttorl, 
                ttrl: cartajsonValue.ttrl, 
                ttwl: cartajsonValue.ttwl, 
                ttwp: cartajsonValue.ttwp, 
