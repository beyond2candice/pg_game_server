...
const leprechaunricheslinhaperda = __importDefault(require("../../jsons/leprechaun-riches/linhaperda")); //输


const leprechaunricheslinhabonus = __importDefault(require("../../jsons/leprechaun-riches/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield leprechaunrichesfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield leprechaunrichesfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = leprechaunrichesjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, leprechaunrichesjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, leprechaunrichesjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return leprechaunricheslinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return leprechaunricheslinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        if (cartajsonValue.fs) {
            ...
            if (fs.hasOwnProperty('lwa')) {
                fs.lwa = allfunctions_1.default.MultiplyValueWithFix(fs.lwa, betRate);
            }
        }
