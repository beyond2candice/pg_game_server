...
const candybonanzalinhaperda = __importDefault(require("../../jsons/candy-bonanza/linhaperda")); //输


const candybonanzalinhabonus = __importDefault(require("../../jsons/candy-bonanza/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield candybonanzafunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield candybonanzafunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = candybonanzajsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, candybonanzajsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, candybonanzajsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return candybonanzalinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return candybonanzalinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                si: { 
                bsp: cartajsonValue.bsp, 
                bspb: cartajsonValue.bspb, 
                bspl: cartajsonValue.bspl, 
                bsplb: cartajsonValue.bsplb, 
                cls: cartajsonValue.cls, 
                cp: allfunctions_1.default.MultiplyCpValue(cartajsonValue.cp, betRate), 
                cwc: cartajsonValue.cwc, 
                dpp: cartajsonValue.dpp, 
