...
const dragonhatch2linhaperda = __importDefault(require("../../jsons/dragon-hatch-2/linhaperda")); //输


const dragonhatch2linhabonus = __importDefault(require("../../jsons/dragon-hatch-2/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield dragonhatch2functions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield dragonhatch2functions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = dragonhatch2jsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, dragonhatch2jsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, dragonhatch2jsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return dragonhatch2linhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return dragonhatch2linhabonus.default.GetJson(json);
    },
