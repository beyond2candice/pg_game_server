...
const fortunegodslinhaperda = __importDefault(require("../../jsons/fortune-gods/linhaperda")); //输

const fortunegodslinhaganho = __importDefault(require("../../jsons/fortune-gods/linhaganho")); //赢


const fortunegodslinhabonus = __importDefault(require("../../jsons/fortune-gods/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield fortunegodsfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield fortunegodsfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = fortunegodsjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, fortunegodsjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, fortunegodsjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return fortunegodslinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return fortunegodslinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return fortunegodslinhabonus.default.GetJson(json);
    },
