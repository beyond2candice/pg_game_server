...
const flirtingscholarlinhaperda = __importDefault(require("../../jsons/flirting-scholar/linhaperda")); //输

const flirtingscholarlinhaganho = __importDefault(require("../../jsons/flirting-scholar/linhaganho")); //赢


const flirtingscholarlinhabonus = __importDefault(require("../../jsons/flirting-scholar/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield flirtingscholarfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield flirtingscholarfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = flirtingscholarjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, flirtingscholarjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, flirtingscholarjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return flirtingscholarlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return flirtingscholarlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return flirtingscholarlinhabonus.default.GetJson(json);
    },
