...
const riofantasialinhaperda = __importDefault(require("../../jsons/rio-fantasia/linhaperda")); //输

const riofantasialinhaganho = __importDefault(require("../../jsons/rio-fantasia/linhaganho")); //赢


const riofantasialinhabonus = __importDefault(require("../../jsons/rio-fantasia/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield riofantasiafunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield riofantasiafunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = riofantasiajsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, riofantasiajsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, riofantasiajsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return riofantasialinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return riofantasialinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return riofantasialinhabonus.default.GetJson(json);
    },
