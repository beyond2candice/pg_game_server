...
const sprmktspreelinhaperda = __importDefault(require("../../jsons/sprmkt-spree/linhaperda")); //输


const sprmktspreelinhabonus = __importDefault(require("../../jsons/sprmkt-spree/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield sprmktspreefunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield sprmktspreefunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = sprmktspreejsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, sprmktspreejsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, sprmktspreejsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return sprmktspreelinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return sprmktspreelinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        if (cartajsonValue.cwc === 1 ) {
            valorganho = allfunctions_1.default.MultiplyValueWithFix(cartajsonValue.lwa+ cartajsonValue.ctw,  betRate);
        }
        ...
        let json = {
            dt: {
                ...
                sm: cartajsonValue.sm, 
                st: cartajsonValue.st, 
                tm: cartajsonValue.tm, 
