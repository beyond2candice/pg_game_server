...
const santasgiftrushlinhaperda = __importDefault(require("../../jsons/santas-gift-rush/linhaperda")); //输

const santasgiftrushlinhaganho = __importDefault(require("../../jsons/santas-gift-rush/linhaganho")); //赢


const santasgiftrushlinhabonus = __importDefault(require("../../jsons/santas-gift-rush/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield santasgiftrushfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield santasgiftrushfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = santasgiftrushjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, santasgiftrushjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, santasgiftrushjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return santasgiftrushlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return santasgiftrushlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return santasgiftrushlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                hsf: cartajsonValue.hsf, 
                isa: cartajsonValue.isa, 
