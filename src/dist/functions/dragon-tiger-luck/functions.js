...
exports.default = {
    ...
    createAndReturnjsontiger(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("CALL create_and_return_dragontigerluckjson(?);", [id]);
            return res[0][0];
        });
    },
    completecallAndSaveJsonSpin(call_id, user_id, json_pin) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("CALL sp_completecall_savejson_dragontigerluckjson(?,?,?);", [call_id, user_id, json_pin]);
            return res[0][0];
        });
    },
    subtrairstepscallAndSaveJsonSpin(call_id, user_id, json_pin) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("CALL sp_subtrirstepscall_savejson_dragontigerluckjson(?,?,?);", [call_id, user_id, json_pin]);
            return res[0][0];
        });
    },
};
