...
const galacticgemslinhaperda = __importDefault(require("../../jsons/galactic-gems/linhaperda")); //输


const galacticgemslinhabonus = __importDefault(require("../../jsons/galactic-gems/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield galacticgemsfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield galacticgemsfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = galacticgemsjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, galacticgemsjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, galacticgemsjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return galacticgemslinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return galacticgemslinhabonus.default.GetJson(json);
    },
