...
const threeczpigslinhaperda = __importDefault(require("../../jsons/three-cz-pigs/linhaperda")); //输


const threeczpigslinhabonus = __importDefault(require("../../jsons/three-cz-pigs/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield threeczpigsfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield threeczpigsfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = threeczpigsjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, threeczpigsjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, threeczpigsjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return threeczpigslinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return threeczpigslinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                cwf: cartajsonValue.cwf, 
                cwp: cartajsonValue.cwp, 
                dpf: cartajsonValue.dpf, 
                dpp: cartajsonValue.dpp, 
                fb: cartajsonValue.fb, 
                frns: cartajsonValue.frns, 
