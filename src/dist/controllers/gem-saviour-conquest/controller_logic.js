...
const gemsaviourconquestlinhaperda = __importDefault(require("../../jsons/gem-saviour-conquest/linhaperda")); //输

const gemsaviourconquestlinhaganho = __importDefault(require("../../jsons/gem-saviour-conquest/linhaganho")); //赢


const gemsaviourconquestlinhabonus = __importDefault(require("../../jsons/gem-saviour-conquest/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield gemsaviourconquestfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield gemsaviourconquestfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = gemsaviourconquestjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, gemsaviourconquestjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, gemsaviourconquestjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return gemsaviourconquestlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return gemsaviourconquestlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return gemsaviourconquestlinhabonus.default.GetJson(json);
    },
