...
const medusalinhaperda = __importDefault(require("../../jsons/medusa/linhaperda")); //输

const medusalinhaganho = __importDefault(require("../../jsons/medusa/linhaganho")); //赢


const medusalinhabonus = __importDefault(require("../../jsons/medusa/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield medusafunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield medusafunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = medusajsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, medusajsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, medusajsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return medusalinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return medusalinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return medusalinhabonus.default.GetJson(json);
    },
