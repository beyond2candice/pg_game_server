...
const thegreaticescapelinhaperda = __importDefault(require("../../jsons/the-great-icescape/linhaperda")); //输


const thegreaticescapelinhabonus = __importDefault(require("../../jsons/the-great-icescape/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield thegreaticescapefunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield thegreaticescapefunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = thegreaticescapejsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, thegreaticescapejsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, thegreaticescapejsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return thegreaticescapelinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return thegreaticescapelinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        if (cartajsonValue.fs) {
            ...
            if (fs.hasOwnProperty('twbm')) {
                fs.twbm= allfunctions_1.default.MultiplyValueWithFix(fs.twbm, betRate);
            }
        }
