...
const heiststakeslinhaperda = __importDefault(require("../../jsons/heist-stakes/linhaperda")); //输


const heiststakeslinhabonus = __importDefault(require("../../jsons/heist-stakes/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield heiststakesfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield heiststakesfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = heiststakesjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, heiststakesjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, heiststakesjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return heiststakeslinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return heiststakeslinhabonus.default.GetJson(json);
    },
