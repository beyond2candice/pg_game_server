...
const werewolfhuntlinhaperda = __importDefault(require("../../jsons/werewolf-hunt/linhaperda")); //输

const werewolfhuntlinhaganho = __importDefault(require("../../jsons/werewolf-hunt/linhaganho")); //赢


const werewolfhuntlinhabonus = __importDefault(require("../../jsons/werewolf-hunt/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield werewolfhuntfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield werewolfhuntfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = werewolfhuntjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, bet, ret, gamename, werewolfhuntjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, werewolfhuntjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return werewolfhuntlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return werewolfhuntlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return werewolfhuntlinhabonus.default.GetJson(json);
    },
