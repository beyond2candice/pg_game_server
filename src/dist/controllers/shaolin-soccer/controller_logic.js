...
const shaolinsoccerlinhaperda = __importDefault(require("../../jsons/shaolin-soccer/linhaperda")); //输

const shaolinsoccerlinhaganho = __importDefault(require("../../jsons/shaolin-soccer/linhaganho")); //赢


const shaolinsoccerlinhabonus = __importDefault(require("../../jsons/shaolin-soccer/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield shaolinsoccerfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield shaolinsoccerfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = shaolinsoccerjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, shaolinsoccerjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, shaolinsoccerjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return shaolinsoccerlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return shaolinsoccerlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return shaolinsoccerlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                ss: cartajsonValue.ss, 
                st: cartajsonValue.st, 
                stp: cartajsonValue.stp, 
