...
const piggygoldlinhaperda = __importDefault(require("../../jsons/piggy-gold/linhaperda")); //输

const piggygoldlinhaganho = __importDefault(require("../../jsons/piggy-gold/linhaganho")); //赢


const piggygoldlinhabonus = __importDefault(require("../../jsons/piggy-gold/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield piggygoldfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield piggygoldfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = piggygoldjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, piggygoldjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, piggygoldjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return piggygoldlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return piggygoldlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return piggygoldlinhabonus.default.GetJson(json);
    },
