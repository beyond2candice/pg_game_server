...
const hawaiiantikilinhaperda = __importDefault(require("../../jsons/hawaiian-tiki/linhaperda")); //输


const hawaiiantikilinhabonus = __importDefault(require("../../jsons/hawaiian-tiki/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield hawaiiantikifunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield hawaiiantikifunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = hawaiiantikijsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
    ...
    taskLostJsonData(json) {
        return hawaiiantikilinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return hawaiiantikilinhabonus.default.GetJson(json);
    },
