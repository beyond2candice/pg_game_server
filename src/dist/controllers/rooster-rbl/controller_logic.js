...
const roosterrbllinhaperda = __importDefault(require("../../jsons/rooster-rbl/linhaperda")); //输


const roosterrbllinhabonus = __importDefault(require("../../jsons/rooster-rbl/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield roosterrblfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield roosterrblfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = roosterrbljsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, roosterrbljsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, roosterrbljsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return roosterrbllinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return roosterrbllinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                otw: allfunctions_1.default.MultiplyValueWithFix(cartajsonValue.otw, betRate),
