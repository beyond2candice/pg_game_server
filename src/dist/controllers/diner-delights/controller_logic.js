...
const dinerdelightslinhaperda = __importDefault(require("../../jsons/diner-delights/linhaperda")); //输


const dinerdelightslinhabonus = __importDefault(require("../../jsons/diner-delights/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield dinerdelightsfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield dinerdelightsfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = dinerdelightsjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, dinerdelightsjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, dinerdelightsjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return dinerdelightslinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return dinerdelightslinhabonus.default.GetJson(json);
    },
