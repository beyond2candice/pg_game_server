...
const speedwinnerlinhaperda = __importDefault(require("../../jsons/speed-winner/linhaperda")); //输


const speedwinnerlinhabonus = __importDefault(require("../../jsons/speed-winner/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield speedwinnerfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield speedwinnerfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = speedwinnerjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, bet, ret, gamename, speedwinnerjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, speedwinnerjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return speedwinnerlinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return speedwinnerlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        for (var i = step + 1; i < propertyCount; i++) 
        {
            ...
            {
                prevBalance = prevBalance + allfunctions_1.default.MultiplyValueWithFix(cartajson[i].np - cartajsonValue.tb, betRate);
            }
            else{
        ...
        let json = {
            dt: {
                ...
                tgm: cartajsonValue.tgm, 
                tmd: cartajsonValue.tmd, 
                torl: cartajsonValue.torl, 
                tptbr: cartajsonValue.tptbr, 
                trl: cartajsonValue.trl, 
                twp: cartajsonValue.twp, 
