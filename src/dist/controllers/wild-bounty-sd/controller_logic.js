...
const wildbountysdlinhaperda = __importDefault(require("../../jsons/wild-bounty-sd/linhaperda")); //输


const wildbountysdlinhabonus = __importDefault(require("../../jsons/wild-bounty-sd/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield wildbountysdfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield wildbountysdfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = wildbountysdjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, wildbountysdjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, wildbountysdjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return wildbountysdlinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return wildbountysdlinhabonus.default.GetJson(json);
    },
