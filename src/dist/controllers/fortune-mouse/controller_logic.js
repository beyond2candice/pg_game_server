...
const fortunemouselinhaperda = __importDefault(require("../../jsons/fortune-mouse/linhaperda")); //输

const fortunemouselinhaganho = __importDefault(require("../../jsons/fortune-mouse/linhaganho")); //赢


const fortunemouselinhabonus = __importDefault(require("../../jsons/fortune-mouse/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield fortunemousefunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield fortunemousefunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = fortunemousejsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, fortunemousejsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, fortunemousejsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return fortunemouselinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return fortunemouselinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return fortunemouselinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                idr: cartajsonValue.idr, 
                ir: cartajsonValue.ir, 
