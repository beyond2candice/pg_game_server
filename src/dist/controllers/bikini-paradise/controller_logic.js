...
const bikiniparadiselinhaperda = __importDefault(require("../../jsons/bikini-paradise/linhaperda")); //输

const bikiniparadiselinhaganho = __importDefault(require("../../jsons/bikini-paradise/linhaganho")); //赢


const bikiniparadiselinhabonus = __importDefault(require("../../jsons/bikini-paradise/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield bikiniparadisefunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield bikiniparadisefunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = bikiniparadisejsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, bikiniparadisejsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, bikiniparadisejsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return bikiniparadiselinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return bikiniparadiselinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return bikiniparadiselinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                wm: cartajsonValue.wm, 
                wp: cartajsonValue.wp, 
                wppr: cartajsonValue.wppr, 
