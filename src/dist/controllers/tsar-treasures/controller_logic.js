...
const tsartreasureslinhaperda = __importDefault(require("../../jsons/tsar-treasures/linhaperda")); //输

const tsartreasureslinhaganho = __importDefault(require("../../jsons/tsar-treasures/linhaganho")); //赢


const tsartreasureslinhabonus = __importDefault(require("../../jsons/tsar-treasures/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield tsartreasuresfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield tsartreasuresfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = tsartreasuresjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, tsartreasuresjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, tsartreasuresjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return tsartreasureslinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return tsartreasureslinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return tsartreasureslinhabonus.default.GetJson(json);
    },
