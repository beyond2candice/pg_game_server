...
const balivacationlinhaperda = __importDefault(require("../../jsons/bali-vacation/linhaperda")); //输

const balivacationlinhaganho = __importDefault(require("../../jsons/bali-vacation/linhaganho")); //赢


const balivacationlinhabonus = __importDefault(require("../../jsons/bali-vacation/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield balivacationfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield balivacationfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = balivacationjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, balivacationjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, balivacationjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return balivacationlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return balivacationlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return balivacationlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                ...
                fa: cartajsonValue.fa, 
                fb: cartajsonValue.fb, 
                fbst: cartajsonValue.fbst, 
                ...
                sp: cartajsonValue.sp, 
                st: cartajsonValue.st, 
                symc: cartajsonValue.symc, 
