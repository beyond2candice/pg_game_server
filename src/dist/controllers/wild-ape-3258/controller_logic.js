...
const wildape3258linhaperda = __importDefault(require("../../jsons/wild-ape-3258/linhaperda")); //输


const wildape3258linhabonus = __importDefault(require("../../jsons/wild-ape-3258/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield wildape3258functions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield wildape3258functions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = wildape3258jsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, wildape3258jsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, wildape3258jsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return wildape3258linhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return wildape3258linhabonus.default.GetJson(json);
    },
