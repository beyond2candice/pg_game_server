...
const emperorsfavourlinhaperda = __importDefault(require("../../jsons/emperors-favour/linhaperda")); //输

const emperorsfavourlinhaganho = __importDefault(require("../../jsons/emperors-favour/linhaganho")); //赢


const emperorsfavourlinhabonus = __importDefault(require("../../jsons/emperors-favour/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield emperorsfavourfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield emperorsfavourfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = emperorsfavourjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, emperorsfavourjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, emperorsfavourjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return emperorsfavourlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return emperorsfavourlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return emperorsfavourlinhabonus.default.GetJson(json);
    },
