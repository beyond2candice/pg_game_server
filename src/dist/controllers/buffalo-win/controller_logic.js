...
const buffalowinlinhaperda = __importDefault(require("../../jsons/buffalo-win/linhaperda")); //输

const buffalowinlinhaganho = __importDefault(require("../../jsons/buffalo-win/linhaganho")); //赢


const buffalowinlinhabonus = __importDefault(require("../../jsons/buffalo-win/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield buffalowinfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield buffalowinfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = buffalowinjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, buffalowinjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, buffalowinjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return buffalowinlinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return buffalowinlinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return buffalowinlinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        for (var i = step + 1; i < propertyCount; i++) 
        {
            ...
            console.log("prevBalance=" + prevBalance + " np=" + cartajson[i].np + " betRate=" + betRate);
        }
        ...
        if (cartajsonValue.cwc === 1 ) {
            valorganho = allfunctions_1.default.MultiplyValueWithFix(cartajsonValue.acw + cartajsonValue.ctw,  betRate);
        }
        ...
        let json = {
            dt: {
                ...
                bsc: cartajsonValue.bsc, 
                bwp: cartajsonValue.bwp, 
                bwsc: cartajsonValue.bwsc, 
                ...
                ix: cartajsonValue.ix, 
                lrs: cartajsonValue.lrs, 
