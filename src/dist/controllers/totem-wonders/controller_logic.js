...
const totemwonderslinhaperda = __importDefault(require("../../jsons/totem-wonders/linhaperda")); //输

const totemwonderslinhaganho = __importDefault(require("../../jsons/totem-wonders/linhaganho")); //赢


const totemwonderslinhabonus = __importDefault(require("../../jsons/totem-wonders/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield totemwondersfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield totemwondersfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = totemwondersjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, totemwondersjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, totemwondersjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return totemwonderslinhaperda.default.GetJson(json);
    },
    ...
    taskWinJsonData(json) {
        return totemwonderslinhaganho.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return totemwonderslinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                si: { 
                clm: cartajsonValue.clm, 
                cm: cartajsonValue.cm, 
                crm: cartajsonValue.crm, 
