...
const jackfrostslinhaperda = __importDefault(require("../../jsons/jack-frosts/linhaperda")); //输


const jackfrostslinhabonus = __importDefault(require("../../jsons/jack-frosts/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield jackfrostsfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield jackfrostsfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = jackfrostsjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, jackfrostsjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, jackfrostsjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return jackfrostslinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return jackfrostslinhabonus.default.GetJson(json);
    },
    GetBonusJson(cartajson, step, ml, cs, bet, prevBalance) {
        ...
        let json = {
            dt: {
                si: { 
                acw: cartajsonValue.acw, 
                agmfb: cartajsonValue.agmfb, 
