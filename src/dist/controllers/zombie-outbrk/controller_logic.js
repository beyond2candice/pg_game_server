...
const zombieoutbrklinhaperda = __importDefault(require("../../jsons/zombie-outbrk/linhaperda")); //输


const zombieoutbrklinhabonus = __importDefault(require("../../jsons/zombie-outbrk/linhabonus")); //大奖
...
exports.default = {
    getGameInfo(token, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let json = yield zombieoutbrkfunctions_1.default.getjsontiger(user_id);
                if (json === null || json.length === 0) {
                    json = yield zombieoutbrkfunctions_1.default.createAndReturnjsontiger(user_id);
                    if (json === null || json.length === 0) {
                        return;
                    }
                }
    ...
    taskJsonMetaByScore(score, bet, gameCode) {
        let ret = zombieoutbrkjsonresult.default.RandomJson(score, bet);
        if (ret) {
            return {
                result:ret.Type,
                gamecode:gameCode,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret) {
                if (ret.Type === 0) {
                    ...
                    return allfunctions_1.default.getBetResultByGameRtpCall(user, agent, ret.Result, gamename, zombieoutbrkjsonresult.default.GetGameJsons());
                }
            }
            return yield allfunctions_1.default.getBetResultScore(user, agent, bet, user_score, token, gamename, zombieoutbrkjsonresult.default.GetGameJsons());
        });
    },
    taskLostJsonData(json) {
        return zombieoutbrklinhaperda.default.GetJson(json);
    },
    ...
    taskBonusJsonData(json) {
        return zombieoutbrklinhabonus.default.GetJson(json);
    },
